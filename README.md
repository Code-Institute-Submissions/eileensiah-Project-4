...
* These Foreign Domestic Workders (FDWs) comes from Philippines, Indonesia, Myanmar and India.
...
* As agencies, in order to provide better service, we would prefer potential employer to shortlist the FDW and email us. This will shorten the sales cycle.
...
UX DESIGN
=========
* This website is designed in an orderly and logical manner. It aims to allow users have an easy time navigating for informations .  User are not required to go beyong 3 clicks to get to their destination.
...
* This website is makeup of 4 parts:
    ...
    * D) Super Admin Page (consists of "Agency Detail" page, "Employer Detail" page, "All Shortlisted Enquiry" page, "Maid List" page and "Product" page )
...
* On the navibar, there are "Home" Page, "Search Maid" page, "Shortlisted" page and "Enquiry" page. 
    * Home Page - It consists of 5 sections
        * The banner has a search box which has dropped down option for users to do a quick search for their prefered FDWS. This is very useful for user who prefer to "go straight to the point". 
        ...
        * After this is the "Testimonial" section, contributed by happy and satisfied users of the website.
...
* On the Agency Admin navibar, there are "General Enquiry" page, "Shortlisted Enquiry" page, "Maid List" page, "Product" page and "Cart" page.
    * General enquiry page - It showed all the general enquiry send in by the potential employers. Employers do not have any prefered FDWs in mind. Therefore, agencies have to recommend FDWs based on emplyoyer requirements.
    * Shortlisted enquiry page - It showed all the shortlisted enquries send in by potential employers. Employers have selected their prefered maid and agencies need to revert back to employers on the next step.
    * Maid List page - It showed all the FDWs that belongs to this agency. In the page, agency is also able create, view, edit and delete any biodata.
...
* I have created the the following app for this project.
    ...
    * Product cart - It showed the product plan that agency has selected.
    * Shortlisted cart - It showed FDWs that potential employer has selected.
...
* Manual testing was employed to check all the button and link is functioning properly.
